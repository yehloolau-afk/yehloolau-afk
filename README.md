...
I don't have a backend. Almost everything is a single HTML file deployed on GitHub Pages.

`Claude Code` · `Vanilla HTML / CSS / JS` · `GitHub Pages` · `Cloudflare Workers`
